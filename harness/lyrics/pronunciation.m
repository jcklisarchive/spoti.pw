...
NSString *SGLyricsTranslationLanguage(void) { return @"en"; }
...
int main(int argc, const char **argv) {
    @autoreleasepool {
        ...
        check(SGKaraokeLeadLine(@[head, overlap], 2000) == 0 && SGKaraokeLeadLine(@[head, overlap], 3500) == 1,
              @"Overlapping voices retain the earlier voice until it finishes");
